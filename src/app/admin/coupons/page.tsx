          ...
          <div className="rounded-3xl border border-white/10 bg-white/[0.04] backdrop-blur-sm p-8">
            ...
            <form onSubmit={handleCreateCoupon} className="space-y-5">
              ...
              <input
                ...
                className="w-full rounded-xl border border-zinc-700 bg-black px-5 py-4 text-white outline-none focus:border-amber-400"
                required
              />
                ...
                <tbody>
                  {coupons.map((c) => (
                    <tr key={c._id} className="border-b border-white/5 hover:bg-white/5">
                      ...
                      <td className="p-5">
                        <span className="px-4 py-2 rounded-full border border-zinc-700 bg-black text-sm font-bold">
                          {c.code}
                        </span>
                      </td>

                      <td className="p-5 text-amber-400 font-bold">
                        {c.discount}%
                      </td>
