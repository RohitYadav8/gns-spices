      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {features.map((f, i) => (
            ...
            >
              {/* Title matches the golden/amber accent from Screenshot 2026-05-29 175509.png */}
              <h3 className="text-xl md:text-2xl font-bold text-amber-500">
                {f.title}
              </h3>
              {/* Description matches the uppercase style from Screenshot 2026-05-29 175509.png */}
